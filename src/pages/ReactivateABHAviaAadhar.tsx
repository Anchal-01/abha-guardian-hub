...
const ReactivateABHAViaAadhaar = () => {
  ...
  const handleSendOtp = async () => {
    ...
    try {
      const response = await fetch(
        `${API_BASE}/curiomed/v1/abdm/reactivate/abha/byaadhaar/request-otp`,
        {
          method: "POST",
          headers: {
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      const response = await fetch(
        `${API_BASE}/curiomed/v1/abdm/reactivate/abha/byaadhaar/verify-otp`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5">
      ...
      <header className="bg-card/50 backdrop-blur-sm border-b shadow-sm">
        <div className="container mx-auto px-4 py-4">
          ...
          <h1 className="text-2xl font-bold">Reactivate ABHA via Aadhaar OTP</h1>
        </div>
      </header>
        ...
        <div className="max-w-md mx-auto space-y-8">
          <Card className="shadow-lg border-0 bg-card/50 backdrop-blur-sm">
            <CardHeader>
              ...
              <CardDescription>We'll send OTP to Aadhaar-linked mobile</CardDescription>
            </CardHeader>
            <CardContent>
...
export default ReactivateABHAViaAadhaar;